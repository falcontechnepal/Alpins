      ...
      <div className="row container py-5 ">
        <div className="col pb-4 col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
          <p className=" lh-lg mainColor">
            ...
            ea commodo consequat. Duis aute irure dolor in reprehenderit.Lorem
            ipsum dolor sit amet consectetur adipiscing elitsed do eiusmod
            tempor incididunt utlabore et dolore magna aliqua. Utenim ad minim
            veniam quis nostrud exercitation ullamco laboris nisi ut aliquipo.
          </p>
        </div>
        <div className="col col-md-12 col-lg-6 col-xl-6">
          <div className="col">
            <div className="row">
            ...
            <div className="row">
              ...
              <div className="col mainColor fw-normal">Monte Veneto Italy</div>
            </div>
